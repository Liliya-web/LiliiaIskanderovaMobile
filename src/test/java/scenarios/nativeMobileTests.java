...
public class nativeMobileTests extends BaseTest {
    ...
    public void userCanNotSignInWithoutCredentials(String expectedMessage)
...
//        ImageIO.write(image, "png", new FileOutputStream(pathToScreenshot));
//        Tesseract tesseract = new Tesseract();
//        tesseract.setDatapath("src/main/resources/tessdata");
//        tesseract.setLanguage("eng");
//        assertThat(tesseract.doOCR(new File(pathToScreenshot)))
//                .as("'" + expectedMessage + "' was not found on the page")
//                .contains(expectedMessage);
    }
}
